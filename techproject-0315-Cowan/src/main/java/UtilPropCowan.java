...
public class UtilPropCowan {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "F:\\UNO\\Year_4\\SPRING\\SW Engineering\\eclipse-workspace\\techproject-0315-Cowan\\src\\main\\webapp\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/techproject-0315-Cowan/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/techproject-0315-Cowan/config.properties";
